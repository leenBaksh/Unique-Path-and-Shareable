...
resumeForm?.addEventListener("submit", (evt) => {
  ...
  (
    document.getElementById("resumeName") as HTMLElement
  ).innerText = `Name: ${name.value}`;
  (
    document.getElementById("resumeEmail") as HTMLElement
  ).innerText = `Email: ${email.value}`;
  (
    document.getElementById("resumePhone") as HTMLElement
  ).innerText = `Phone: ${phone.value}`;
  (
    document.getElementById("resumeEducation") as HTMLElement
  ).innerText = `Education: ${education.value}`;
  (
    document.getElementById("resumeExperience") as HTMLElement
  ).innerText = `Experience: ${experience.value}`;
  (
    document.getElementById("resumeSkils") as HTMLElement
  ).innerText = `Skills: ${skills.value}`;
});
